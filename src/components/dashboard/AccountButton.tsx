  ...
  return (
    <div className="group relative flex items-center">
      <div className="flex items-center gap-4">
        <div className="h-12 w-12 overflow-hidden rounded-full ring-2 ring-gray-100 dark:ring-gray-800">
          <img
            src={profilePic}
      ...
      <div className="invisible absolute right-0 top-15 z-999 w-[280px] rounded-lg border-[.5px] border-stroke bg-white pb-2.5 pt-3.5 opacity-0 shadow-md transition-all duration-300 ease-in-out group-hover:visible group-hover:translate-y-2 group-hover:opacity-100 dark:bg-gray-dark dark:border-gray-700">
